...
namespace Webshop_Project.Controllers
{
    ...
    public class SmartphoneController : ControllerBase
    {
        ...
        public async Task<ActionResult<SmartphoneDTO>> GetAllSmartphonesAsync(int? enterBrandID, int? enterCategoryID, int? enterMemoryCapacity, int? enterMinPrice, int? enterMaxPrice, int page = 1, int items = 40)
        {
